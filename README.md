...
- AI(**Gemma 3**)가 별들의 배치를 분석하고, **FLUX.1**이 고유한 성운(Nebula) 이미지를 생성해 배경으로 깔아줍니다.
...
| Role | Name | Comment |
| :--- | :--- | :--- |
| **Frontend/Design** | **이준엽** | "Interactive 3D Experience & UI/UX" |
| **Backend/AI** | **박찬우** | "System Architecture & Intelligence Pipeline" |
